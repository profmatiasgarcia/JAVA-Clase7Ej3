...
public class Direccion2 implements Serializable {
    ...
    public Direccion2(String calle, int numero, String dpto, String localidad, String provincia) {
        this.calle = calle;
        this.numero = numero;
        this.dpto = dpto;
    ...
    public String toString() {
        return "Direccion{" + "id=" + id + ", calle=" + calle + ", numero=" + numero + ", dpto=" + dpto + ", localidad=" + localidad + ", provincia=" + provincia + '}';
    }
