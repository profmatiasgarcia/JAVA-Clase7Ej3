...
public class CorreoElectronico2 implements Serializable {
    ...
    public CorreoElectronico2(String direccionCorreo, Profesor4 profesor) {
    ...
    public String toString() {
        return "CorreoElectronico{" + "idCorreo=" + idCorreo + ", direccionCorreo=" + direccionCorreo + ", profesor=" + profesor + '}';
    }
