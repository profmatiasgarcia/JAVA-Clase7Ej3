...
//    private List<Persona> listPersonas() {
    ...
    private void addEventoAPersona(Integer personaId, Integer eventoId) {
        ...
        Persona laPerson = (Persona) session.load(Persona.class, personaId);
        Evento elEvento = (Evento) session.load(Evento.class, eventoId);
    ...
    private void addNuevoEventoAPersona(String tituloEvento, Date fechaEvento,
        ...
        Persona laPersona = (Persona) session.load(Persona.class, personaId);
